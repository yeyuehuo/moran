...
# 卸载命令：
wget -N --no-check-certificate https://raw.githubusercontent.com/yeyuehuo/moran/master/caddy_install.sh && chmod +x caddy_install.sh && bash caddy_install.sh uninstall
```
